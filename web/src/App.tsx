...
const CONTROLLER_RELEASE_URL = 'https://github.com/llcjustix/clubpay-platform/releases/download/controller-v0.2.17/ClubPay-Controller-win-x64.zip';
const MANAGER_RELEASE_URL = 'https://github.com/llcjustix/clubpay-core-agent/releases/download/v0.4.19/ClubPay-Manager-Desktop-win-x64.zip';
