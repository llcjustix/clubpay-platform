...
func (s *Server) mobileRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("POST /api/mobile/active-session/end", s.mobileMutation(s.handleMobileActiveSessionEnd))
	...
	mux.HandleFunc("POST /api/mobile/reservations/{reservation_id}/start", s.mobileMutation(s.handleMobileReservationStart))
